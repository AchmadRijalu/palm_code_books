...
class DetailBooksModel {
    ...
    factory DetailBooksModel.fromRawJson(String str) => DetailBooksModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory DetailBooksModel.fromJson(Map<String, dynamic> json) => DetailBooksModel(
        id: json["id"],
        title: json["title"],
